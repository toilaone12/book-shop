  ...
  <header>
    ...
    <div class="user-box" style="display: flex; align-items:center;">
      ...
      <?php if (isset($_SESSION['user_name'])) { ?>
        <img style="height:40px; margin-left:10px ;" src="images/2.png" class="user-pic" onclick="toggleMenu()" />
      <?php } else { ?>
        <div class="use_links"><a class="btn-login" href="login.php"><i class="fa-solid fa-right-to-bracket"></i> Login</a>
      <?php } ?>
    </div>

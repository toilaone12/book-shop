            ...
            <div class="col-50">
              <div class="col-25">
                <div class="container">
                  ...
                  ?>
                      <p> <a href="book_details.php?details=<?php echo $fetch_cart['book_id']; ?>"><?php echo $fetch_cart['name']; ?></a><span class="price">(<?php echo number_format($fetch_cart['price'],0,',','.') . ' VND' . ' x ' . $fetch_cart['quantity']; ?>)</span> </p>
                  <?php
                    }
                  } else {
                  ...
                  <hr>
                  <p>Grand total : <span class="price" style="color:black"><b><?php echo number_format($grand_total,0,',','.'); ?> VND</b></span></p>
                </div>
              </div>
